...
public enum FixtureRecorder {
    ...
    /// Records the snapshot and the base and head contents of every text file.
    public static func record(
        ...
        for file in snapshot.files {
            ...
            if file.status != .added { requests.append((pullRequest.baseOid, file.previousPath ?? file.path)) }
